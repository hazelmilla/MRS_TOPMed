...
setwd("/work/users/h/e/hemilla/MRS_permutations/Output")
null_scores_matrix <- readRDS("JHSv1_MRS_permutations_Bonferroni.rds")
...
setwd("/work/users/h/e/hemilla/MRS_permutations/Output")
saveRDS(resid_matrix, file = "JHSv1_MRS_permutations_residualized_Bonferroni.rds")

# JHS V2
setwd("/work/users/h/e/hemilla/MRS_permutations/Output")
null_scores_matrix <- readRDS("JHSv2_MRS_permutations_Bonferroni.rds")
...
setwd("/work/users/h/e/hemilla/MRS_permutations/Output")
saveRDS(resid_matrix, file = "JHSv2_MRS_permutations_residualized_Bonferroni.rds")

# MESA
setwd("/work/users/h/e/hemilla/MRS_permutations/Output")
null_scores_matrix <- readRDS("MESA_MRS_permutations_Bonferroni.rds")
...
setwd("/work/users/h/e/hemilla/MRS_permutations/Output")
saveRDS(resid_matrix, file = "MESA_MRS_permutations_residualized_Bonferroni.rds")
...
setwd("/work/users/h/e/hemilla/MRS_permutations/Output")
perm_matrix <- readRDS("JHSv1_MRS_permutations_residualized_Bonferroni.rds")
...
#check HR value ranges
range(perm_results_df$HR)
sum(perm_results_df$P_value < 0.05) #0

names(ph_tests) <- 1:1000
violating_vars <- names(ph_tests)[sapply(ph_tests, function(x) x$table[1, 3] < 0.05)]
print(violating_vars)

write.csv(perm_results_df, file = "JHSv1_permutation_results_Bonferroni.csv", row.names = FALSE)
...
setwd("/work/users/h/e/hemilla/MRS_permutations/Output")
perm_matrix <- readRDS("JHSv2_MRS_permutations_residualized_Bonferroni.rds")
...
#check HR value ranges
range(perm_results_df$HR)
sum(perm_results_df$P_value < 0.05) #586

names(ph_tests) <- 1:1000
violating_vars <- names(ph_tests)[sapply(ph_tests, function(x) x$table[1, 3] < 0.05)]
print(violating_vars)

write.csv(perm_results_df, file = "JHSv2_permutation_results_Bonferroni.csv", row.names = FALSE)
...
setwd("/work/users/h/e/hemilla/MRS_permutations/Output")
perm_matrix <- readRDS("MESA_MRS_permutations_residualized_Bonferroni.rds")
...
perm_matrix <- perm_matrix[order(match(rownames(perm_matrix), covariates$TOEID)),]
identical((rownames(perm_matrix) %>% as.integer()), covariates$TOEID)
dim(perm_matrix) #[1] 609
...
#check HR value ranges
range(perm_results_df$HR)
sum(perm_results_df$P_value < 0.05) #3304

names(ph_tests) <- 1:1000
violating_vars <- names(ph_tests)[sapply(ph_tests, function(x) x$table[1, 3] < 0.05)]
print(violating_vars)

write.csv(perm_results_df, file = "MESA_permutation_results_Bonferroni.csv", row.names = FALSE)
...
v1 <- read.csv("JHSv1_permutation_results_Bonferroni.csv", header = TRUE)
v2 <- read.csv("JHSv2_permutation_results_Bonferroni.csv", header = TRUE)
mesa <- read.csv("MESA_permutation_results_Bonferroni.csv", header = TRUE)
...
sum(meta_coef_df$p_het < 0.05) # 679
sum(meta_coef_df$p_meta < 0.05) # 510
sum(meta_coef_df$q_meta < 0.05) # 0
sum(meta_coef_df$bonferroni < 0.05) # 0

write.csv(meta_coef_df, file = "MRS_permutations_CHD_MESA_JHS_meta_Bonferroni.csv")

meta_coef_df_non_hg <- meta_coef_df %>% filter(p_het > 0.05)
sum(meta_coef_df_non_hg$p_meta < 0.05) # 481
...
sum(meta_coef_df$p_het < 0.05) # 43
sum(meta_coef_df$p_meta < 0.05) # 26
sum(meta_coef_df$q_meta < 0.05) # 0
sum(meta_coef_df$bonferroni < 0.05) # 0

write.csv(meta_coef_df, file = "MRS_permutations_CHD_MESA_JHS_heterogeneous_iterations_meta_Bonferroni.csv")

# Calculate p-value
setwd("/work/users/h/e/hemilla/MRS_permutations/Output")
meta_coef_df <- read.csv("MRS_permutations_CHD_MESA_JHS_meta_Bonferroni.csv")
meta_coef_df_non_hg <- read.csv("MRS_permutations_CHD_MESA_JHS_heterogeneous_iterations_meta_Bonferroni.csv")

z_obs <- 1.1005
z_perm <- c(meta_coef_df$z, meta_coef_df_non_hg$z)
p_perm <- (sum(z_perm >= z_obs) + 1) / (length(z_perm) + 1) #0.09775281
...
ggsave("JHS_MESA_MRS_CHD_permutations_Bonferroni.png", z_plot, width = 10, 
       height = 7, units = "in", dpi = 300)
